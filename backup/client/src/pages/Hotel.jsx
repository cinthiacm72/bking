  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <section
          className='container-fluid-lg flex flex-gap-lg box bg-white'
          data-translate-sm
          data-box-shadow>
          <div style={{ flexBasis: "50%" }}>
            ...
            <p className='badge inline-block margin-bottom-sm fs-tiny bold caps text-white bg-accent'>
              {data.type} / {data.city}
            </p>
            ...
            <p
              className='margin-bottom-md padding-bottom-sm fs-small'
              data-rule>
