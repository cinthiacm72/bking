...
/* app.get("/hotels/countbytype", hotelsController.countByType) */ app.get(
  "/hotels/find/countbytype",
  hotelsController.countByType
);
...
/* app.get("/hotels/hotelsbycity/:city", hotelsController.getHotelsByCity); */
